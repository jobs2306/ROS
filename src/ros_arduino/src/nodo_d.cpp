...
int main(int argc, char **argv)
{
 //se inicializa el nodo
  ros::init(argc, argv, "nodo_d");

  //Se crean los publisher
  ros::NodeHandle n;
  ros::Publisher pub1_String =   n.advertise<std_msgs::String>("topic_d_g", 10);

  //subscriber
  ros::Subscriber sub1_String = n.subscribe("topic_a_d", 10, Callback_a);
